...
class TestConstraintValidator:
    ...
    @pytest.mark.xfail(reason="KNOWN BUG: Mixed hazardous+fragile products fail to find valid shipping methods")
    ...
    @pytest.mark.xfail(reason="KNOWN BUG: Multiple mixed products also trigger the same issue")
