"""Unit tests for ConstraintValidator - regression tests should pass in fixed version."""
...
class TestConstraintValidator:
    ...
    def test_mixed_hazardous_fragile_regression(self):
        """
        Mixed products (hazardous + fragile) should work.
        """
        product = Product(
            id="P005",
        ...
        # PRIORITY_GROUND should also be available
    ...
    def test_order_with_multiple_mixed_products(self):
        """
        Order with multiple mixed-type products should have both ground options.
        """
        products = [
            Product(
                id="P006",
