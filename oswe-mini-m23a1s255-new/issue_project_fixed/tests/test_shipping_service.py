"""Integration tests for ShippingService - fixed regression verified."""
...
class TestShippingService:
    ...
    def test_mixed_product_working_scenario(self):
        """
        REGRESSION TEST: Previously working scenario now fixed.
    ...
    def test_get_recommended_for_mixed_product(self):
        """
        REGRESSION TEST: Getting recommended shipping for mixed product should return cheapest ground option.
        """
        product = Product(
            id="P105",
